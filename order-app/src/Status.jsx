    ...
    <div key={id} className="order-card">
      ...
      <div className="ordered-status">
        ...
        <div className="order-footer">
          ...
          <button className="button" onClick={()=>{ deleteData(datas._id);  window.location.reload(); console.log("clicked")}}>
...
<div>
 <p className="text-center font-bold m-5 text-2xl">Loading... Please Wait... or Contact HAKKIM </p>
 </div>
